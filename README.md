...
Sends a daily email at 6:00 AM (WAT) with the current USD price and 24h
% change for Bitcoin, Ethereum, BNB, Pi Network, and Toncoin — powered by
the free [CoinGecko API](https://www.coingecko.com/en/api) and run
entirely on GitHub Actions (no server needed).
